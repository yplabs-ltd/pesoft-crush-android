...
public class CrystalRangeSeekbar extends View {
    ...
    private CrystalRangeSeekbar.Thumb pressedThumb;
    ...
    public CrystalRangeSeekbar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, com.example.crystalrangeseekbar.R.styleable.CrystalRangeSeekbar);
        try{
    ...
    public void apply(){
        ...
        thumbWidth  = (leftThumb != null)  ? leftThumb.getWidth()   : getResources().getDimension(com.example.crystalrangeseekbar.R.dimen.thumb_width);
        thumbHeight = (rightThumb != null) ? rightThumb.getHeight() : getResources().getDimension(com.example.crystalrangeseekbar.R.dimen.thumb_height);
    ...
    protected CrystalRangeSeekbar.Thumb getPressedThumb(){
        return pressedThumb;
    }

    protected float getThumbWidth(){
        return (leftThumb != null)  ? leftThumb.getWidth() : getResources().getDimension(com.example.crystalrangeseekbar.R.dimen.thumb_width);
    }

    protected float getThumbHeight(){
        return (leftThumb != null)  ? leftThumb.getHeight() : getResources().getDimension(com.example.crystalrangeseekbar.R.dimen.thumb_height);
    }

    protected float getBarHeight(){
//        return (thumbHeight * 0.5f) * 0.3f;
        return getContext().getResources().getDimensionPixelSize(R.dimen.seekbar_bar_height);
    }
    ...
    protected float getCornerRadius(final TypedArray typedArray){
        return typedArray.getFloat(com.example.crystalrangeseekbar.R.styleable.CrystalRangeSeekbar_corner_radius, 0f);
    }

    protected float getMinValue(final TypedArray typedArray){
        return typedArray.getFloat(com.example.crystalrangeseekbar.R.styleable.CrystalRangeSeekbar_min_value, 0f);
    }

    protected float getMaxValue(final TypedArray typedArray){
        return typedArray.getFloat(com.example.crystalrangeseekbar.R.styleable.CrystalRangeSeekbar_max_value, 100f);
    }

    protected float getMinStartValue(final TypedArray typedArray){
        return typedArray.getFloat(com.example.crystalrangeseekbar.R.styleable.CrystalRangeSeekbar_min_start_value, minValue);
    }

    protected float getMaxStartValue(final TypedArray typedArray){
        return typedArray.getFloat(com.example.crystalrangeseekbar.R.styleable.CrystalRangeSeekbar_max_start_value, maxValue);
    }

    protected float getSteps(final TypedArray typedArray){
        return typedArray.getFloat(com.example.crystalrangeseekbar.R.styleable.CrystalRangeSeekbar_steps, NO_STEP);
    }

    protected float getGap(final TypedArray typedArray){
        return typedArray.getFloat(com.example.crystalrangeseekbar.R.styleable.CrystalRangeSeekbar_gap, 0f);
    }

    protected float getFixedGap(final TypedArray typedArray){
        return typedArray.getFloat(com.example.crystalrangeseekbar.R.styleable.CrystalRangeSeekbar_fix_gap, NO_FIXED_GAP);
    }

    protected int getBarColor(final TypedArray typedArray){
        return typedArray.getColor(com.example.crystalrangeseekbar.R.styleable.CrystalRangeSeekbar_bar_color, Color.GRAY);
    }

    protected int getBarHighlightColor(final TypedArray typedArray){
        return typedArray.getColor(com.example.crystalrangeseekbar.R.styleable.CrystalRangeSeekbar_bar_highlight_color, Color.BLACK);
    }

    protected int getLeftThumbColor(final TypedArray typedArray){
        return typedArray.getColor(com.example.crystalrangeseekbar.R.styleable.CrystalRangeSeekbar_left_thumb_color, Color.BLACK);
    }

    protected int getRightThumbColor(final TypedArray typedArray){
        return typedArray.getColor(com.example.crystalrangeseekbar.R.styleable.CrystalRangeSeekbar_right_thumb_color, Color.BLACK);
    }

    protected int getLeftThumbColorPressed(final TypedArray typedArray){
        return typedArray.getColor(com.example.crystalrangeseekbar.R.styleable.CrystalRangeSeekbar_left_thumb_color_pressed, Color.DKGRAY);
    }

    protected int getRightThumbColorPressed(final TypedArray typedArray){
        return typedArray.getColor(com.example.crystalrangeseekbar.R.styleable.CrystalRangeSeekbar_right_thumb_color_pressed, Color.DKGRAY);
    }

    protected Drawable getLeftDrawable(final TypedArray typedArray){
        return typedArray.getDrawable(com.example.crystalrangeseekbar.R.styleable.CrystalRangeSeekbar_left_thumb_image);
    }

    protected Drawable getRightDrawable(final TypedArray typedArray){
        return typedArray.getDrawable(com.example.crystalrangeseekbar.R.styleable.CrystalRangeSeekbar_right_thumb_image);
    }

    protected Drawable getLeftDrawablePressed(final TypedArray typedArray){
        return typedArray.getDrawable(com.example.crystalrangeseekbar.R.styleable.CrystalRangeSeekbar_left_thumb_image_pressed);
    }

    protected Drawable getRightDrawablePressed(final TypedArray typedArray){
        return typedArray.getDrawable(com.example.crystalrangeseekbar.R.styleable.CrystalRangeSeekbar_right_thumb_image_pressed);
    }

    protected int getDataType(final TypedArray typedArray){
        return typedArray.getInt(com.example.crystalrangeseekbar.R.styleable.CrystalRangeSeekbar_data_type, CrystalRangeSeekbar.DataType.INTEGER);
    }
    ...
    protected void setupLeftThumb(final Canvas canvas, final Paint paint, final RectF rect){
        leftThumbColor = (CrystalRangeSeekbar.Thumb.MIN.equals(pressedThumb)) ? leftThumbColorPressed : leftThumbColorNormal;
        ...
        if(leftThumb != null){
            Bitmap lThumb = (CrystalRangeSeekbar.Thumb.MIN.equals(pressedThumb)) ? leftThumbPressed : leftThumb;
    ...
    protected void setupRightThumb(final Canvas canvas, final Paint paint, final RectF rect){
        ...
        rightThumbColor = (CrystalRangeSeekbar.Thumb.MAX.equals(pressedThumb)) ? rightThumbColorPressed : rightThumbColorNormal;
        ...
        if(rightThumb != null){
            Bitmap rThumb = (CrystalRangeSeekbar.Thumb.MAX.equals(pressedThumb)) ? rightThumbPressed : rightThumb;
    ...
    protected void trackTouchEvent(MotionEvent event){
        ...
        try{
            ...
            if (CrystalRangeSeekbar.Thumb.MIN.equals(pressedThumb)) {
                setNormalizedMinValue(screenToNormalized(x));
            } else if (CrystalRangeSeekbar.Thumb.MAX.equals(pressedThumb)) {
    ...
    private CrystalRangeSeekbar.Thumb evalPressedThumb(float touchX){
        CrystalRangeSeekbar.Thumb result = null;

        boolean minThumbPressed = isInThumbRange(touchX, normalizedMinValue);
        boolean maxThumbPressed = isInThumbRange(touchX, normalizedMaxValue);
        if (minThumbPressed && maxThumbPressed) {
            // if both thumbs are pressed (they lie on top of each other), choose the one with more room to drag. this avoids "stalling" the thumbs in a corner, not being able to drag them apart anymore.
            result = (touchX / getWidth() > 0.5f) ? CrystalRangeSeekbar.Thumb.MIN : CrystalRangeSeekbar.Thumb.MAX;
        }
        else if(minThumbPressed){
            result = CrystalRangeSeekbar.Thumb.MIN;
        }
        else if(maxThumbPressed){
            result = CrystalRangeSeekbar.Thumb.MAX;
        }
        return result;
    }
    ...
    private <T extends Number> Number formatValue(T value) throws IllegalArgumentException{
        ...
        if (dataType == CrystalRangeSeekbar.DataType.LONG) {
            return v.longValue();
        }
        if (dataType == CrystalRangeSeekbar.DataType.DOUBLE) {
            return v;
        }
        if (dataType == CrystalRangeSeekbar.DataType.INTEGER) {
            return Math.round(v);
        }
        if (dataType == CrystalRangeSeekbar.DataType.FLOAT) {
            return v.floatValue();
        }
        if (dataType == CrystalRangeSeekbar.DataType.SHORT) {
            return v.shortValue();
        }
        if (dataType == CrystalRangeSeekbar.DataType.BYTE) {
            return v.byteValue();
        }
